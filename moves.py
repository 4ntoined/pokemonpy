...
moremoves=[
        ...
        #max moves
        ("Max Flare (P)",150,100,1,0,1,1,0,"A Fire-type Dynamax move! Causes harsh sunlight for five turns.","maxmove sun"),
        ("Max Flare (S)",150,100,1,1,0,1,0,"A Fire-type Dynamax move! Causes harsh sunlight for five turns.","maxmove sun"),
