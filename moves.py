...
moremoves=[
        ...
        ("Leaf Storm",130,90,5,1,0,3,"The user whips up a storm of leaves around the target.\nLowers the user's SpA. by 2 stages.",'stat self,sa,-2,100'),
        ...
        ("Focus Blast",120,70,5,1,0,6,"The user heightens its mental focus an unleashs its power\n10% chance to lower target's SpD. 1 stage.","stat targ,sa,-1,10"),
        ("Clanging Scales",110,100,5,1,0,14,"Scales go bang.","stat self,de,-1,100"),
        ("Fire Blast",110,85,5,1,0,1,"The user attacks with a blast of all-consuming flames.\n10% chance to burn target.","burn 10"),
        ("Hydro Pump",110,80,5,1,0,2,"The user blasts the target with a huge volume of water under great pressure.","null"),
        #("Blizzard",110,70,5,1,0,5,"The user summons a howling blizzard to strike the target.\n10% chance to freeze.","frze 10 blizzard"), #doesn't miss in hail, need to program
        ...
        ("Air Slash",75,95,15,1,0,9,"The user attacks with a blade of air that slices the sky.\n30% chance to make the target flinch.","flinch 30"),
        ...
        ("Amnesia",0,100,20,2,0,10,"The user empties its mind and forgets its concerns.\nBoosts SpD. 2 stages.","stat self,sd,2 noMiss"),
